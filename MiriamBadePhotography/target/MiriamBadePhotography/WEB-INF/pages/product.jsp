...
<body>
	...
	<section>
		...
		<div style="padding-top: 100px; padding-bottom: 10px;">Add a Photo</div>

		<div id="form">
			<c:url var="addAction" value="/product/add"></c:url>

			<form:form modelAttribute="productForm" enctype="multipart/form-data"
				...
				<table>
					...
					<tr>
						...
						<td><form:select path="category" dir=""
								items="${listCategories}" /></td>
					</tr>
					<tr>
						<td>&nbsp;</td>
					</tr>
					...
					<tr>
						<td><input type="submit"
							value="<spring:message text="Add Photo"/>" /></td>
